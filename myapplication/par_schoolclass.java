...
public class par_schoolclass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_par_schoolclass);
        ...
        post1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(  par_schoolclass.this,par_post.class);
                startActivity(i);
            }
        });
        ...
        post3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(  par_schoolclass.this,par_activitypic.class);
                startActivity(i);
            }
        });
        ...
        post4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(  par_schoolclass.this,par_main_screen.class);
                startActivity(i);
            }
        });
    }
