...
public class mem_small_newkid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_small_newkid);
        ...
        modify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mem_small_newkid.this,mem_small_newkid_modify.class);
                startActivity(i);
            }
        });
        ...
        bpost2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mem_small_newkid.this,mem_newkid_inform.class);
                startActivity(i);
            }
        });
        ...
        post1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent( mem_small_newkid.this,mem_post.class);
                startActivity(i);
            }
        });
        ...
        post3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent( mem_small_newkid.this,mem_activityvideo_show.class);
                startActivity(i);
            }
        });
        ...
        post4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent( mem_small_newkid.this,mem_main_screen.class);
                startActivity(i);
            }
        });
    }
