...
public class mem_schoolclass_show extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_schoolclass_show);
        ...
        modify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent( mem_schoolclass_show.this,mem_schoolclass.class);
                startActivity(i);
        ...
        post1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mem_schoolclass_show.this,mem_post.class);
                startActivity(i);
            }
        });
        ...
        post3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mem_schoolclass_show.this,mem_activityvideo_show.class);
                startActivity(i);
            }
        });
        ...
        post4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mem_schoolclass_show.this,mem_main_screen.class);
                startActivity(i);
            }
        });
        ...
        bpost2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent( mem_schoolclass_show.this,mem_newkid_inform.class);
                startActivity(i);
            }
        });
    }
